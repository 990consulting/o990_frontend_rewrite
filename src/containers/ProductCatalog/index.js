...
import { search, resources } from 'routes/internal';
...
const ProductCatalog = ({
  ...
  return (
    <div className={classNames("ProductCatalog", classes.root)}>
      <Helmet defer={false}>
        <title>{title}</title>
...
export default withStyles(styles)(withRouter(ProductCatalog));
